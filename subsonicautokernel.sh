#!/bin/bash
#######################################################################################
#The purpose of this script is to automate the production of an inviscid unsteady kernel
#
#
...
#This script should be executed in a directory that only has the 4 necessary to make a Rocflu run on HIPERGATOR: 
